...
@section('content')
    <div class="bg-gray-800 rounded-lg shadow-lg p-6 tech-border">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-white">Tambah Pertandingan Baru</h1>
        </div>
                ...
                <div class="bg-gray-900 p-6 rounded-lg tech-border">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="teams" id="teams" value="{{ old('teams') }}" 
                                   class="w-full bg-gray-800 border border-gray-700 rounded pl-10 py-2.5 text-white focus:border-cyan-500 focus:ring focus:ring-cyan-500/30 transition-colors"
                                   required>
                        </div>
                        @error('teams')
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            <textarea name="description" id="description" rows="5" 
                                     class="w-full bg-gray-800 border border-gray-700 rounded py-2.5 px-3 text-white focus:border-cyan-500 focus:ring focus:ring-cyan-500/30 transition-colors">{{ old('description') }}</textarea>
                        </div>
                        @error('description')
                            <p class="text-red-400 text-sm mt-1 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
